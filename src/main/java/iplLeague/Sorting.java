...
public class Sorting {
    public enum sortingFields{
        AVG_BATTING, STRIKING_RATE, SIXES_FOURS, SIXES_FOUR_STRIKES
    }
    ...
    public Comparator getField(Sorting.sortingFields sortField)
    {
        ...
        comparatorMap.put(sortingFields.STRIKING_RATE,(Player1,Player2)-> (int) (Player2.strikeRate-Player2.strikeRate));
